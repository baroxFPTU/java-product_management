...
public class ProductServiceSingleton {
    ...
    private static ProductServiceSingleton _instance;
    ...
    public static ProductServiceSingleton getInstance() {
        if (_instance == null) {
            _instance = new ProductServiceSingleton();
        }
        return ProductServiceSingleton._instance;
    }
